...
Revision: bfdd356f2f99c6a5c861db8e84cf464dc6774827
...
Consumers include it as `"unicodelib/unicodelib.h"` and
`"unicodelib/unicodelib_encodings.h"`.
...
`src/tokenizer.h` alongside this update only catches the *old* decoder's
truncated-input case (both revisions return 0 there); it does not catch bad
